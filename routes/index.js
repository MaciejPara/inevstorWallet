...
module.exports = [
    ...
    // crypto
    { method: "get", route: "/cryptos", controller: (req, res) => CryptoController.getAll({req, res}) },
    { method: "post", route: "/crypto", controller: (req, res) => CryptoController.create({req, res}) },
    { method: "get", route: "/crypto/:id", controller: (req, res) => CryptoController.getOne({req, res}) },
    { method: "delete", route: "/crypto/:id", controller: (req, res) => CryptoController.delete({req, res}) },
    { method: "patch", route: "/crypto/:id", controller: (req, res) => CryptoController.update({req, res}) },

    // crypto rate
    { method: "get", route: "/cryptoRates", controller: (req, res) => CryptoRateController.getAll({req, res}) },
    { method: "post", route: "/cryptoRate", controller: (req, res) => CryptoRateController.create({req, res}) },
    { method: "get", route: "/cryptoRate/:id", controller: (req, res) => CryptoRateController.getOne({req, res}) },
    { method: "delete", route: "/cryptoRate/:id", controller: (req, res) => CryptoRateController.delete({req, res}) },
    { method: "patch", route: "/cryptoRate/:id", controller: (req, res) => CryptoRateController.update({req, res}) },

    // crypto
    { method: "get", route: "/metals", controller: (req, res) => MetalController.getAll({req, res}) },
    { method: "post", route: "/metal", controller: (req, res) => MetalController.create({req, res}) },
    { method: "get", route: "/metal/:id", controller: (req, res) => MetalController.getOne({req, res}) },
    { method: "delete", route: "/metal/:id", controller: (req, res) => MetalController.delete({req, res}) },
    { method: "patch", route: "/metal/:id", controller: (req, res) => MetalController.update({req, res}) },

    // crypto rate
    { method: "get", route: "/metalRates", controller: (req, res) => MetalRateController.getAll({req, res}) },
    { method: "post", route: "/metalRate", controller: (req, res) => MetalRateController.create({req, res}) },
    { method: "get", route: "/metalRate/:id", controller: (req, res) => MetalRateController.getOne({req, res}) },
    { method: "delete", route: "/metalRate/:id", controller: (req, res) => MetalRateController.delete({req, res}) },
    { method: "patch", route: "/metalRate/:id", controller: (req, res) => MetalRateController.update({req, res}) },
];
